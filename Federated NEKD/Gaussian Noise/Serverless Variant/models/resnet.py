...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_filters, num_classes=10):
        super(ResNet, self).__init__()
        self.in_planes = num_filters[0]

        self.conv1 = nn.Conv2d(
            3, num_filters[0], kernel_size=3, stride=1, padding=1, bias=False
        )
...
def ResNet18(num_classes=10):
    return ResNet(BasicBlock, [1, 1, 1, 1], [32, 32, 64, 64], num_classes=num_classes)