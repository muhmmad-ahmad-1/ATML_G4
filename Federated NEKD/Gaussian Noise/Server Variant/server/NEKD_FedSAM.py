...
class NEKD_FedSAM(Server):
    def __init__(self,args : Args, random_init :bool = False , aggregation:str = "default"):
        super(NEKD_FedSAM,self).__init__(args,random_init,aggregation)
    ...
    def aggregate_grad(self):
        ...
        distiller = NEKD(teachers,self.global_model,lambd1,lambd2,distillation_epochs,distillation_lr,100,256)
        ...
        self.reliability[self.r] = reliability
