...
class Client:
    ...
    def distill(self,args,teacher_models,student_model=None):
        ...
        student_model,reliability,distill_loss = NEKD(teacher_models,student_model, args.lambd1, args.lambd2, args.distill_epochs, args.distill_lr,distill_dataloader,args.alpha1,args.alpha2,args.beta,args.dataset).train()
